...
public class PoisonimbuepotionItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:poisonimbuepotion")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PalamodItemGroup.tab).maxStackSize(1).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(0).saturation(0.3f)
							...
							.build()));
			setRegistryName("poisonimbuepotion");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			AddpoisonimbueProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
