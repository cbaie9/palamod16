...
public class BigdynamiteItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:bigdynamite")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			BigdynaspawnProcedure.executeProcedure(Stream
