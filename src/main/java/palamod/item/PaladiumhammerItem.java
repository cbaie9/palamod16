...
public class PaladiumhammerItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladiumhammer")
	public static final Item block = null;

	public PaladiumhammerItem(PalamodModElements instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("paladiumhammer"));
	}
}
