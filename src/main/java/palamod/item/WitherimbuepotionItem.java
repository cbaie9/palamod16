...
public class WitherimbuepotionItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:witherimbuepotion")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(PalamodItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(0).saturation(0.3f)
							...
							.build()));
			setRegistryName("witherimbuepotion");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			AddwitherimbueProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
