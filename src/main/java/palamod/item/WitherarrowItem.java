...
import palamod.entity.renderer.WitherarrowRenderer;
...
public class WitherarrowItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:witherarrow")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(PalamodItemGroup.tab).maxDamage(100));
			setRegistryName("witherarrow");
		}
