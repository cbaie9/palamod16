...
public class PaladiumShovelItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladium_shovel")
	public static final Item block = null;

	public PaladiumShovelItem(PalamodModElements instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("paladium_shovel"));
	}
}
