...
import palamod.gui.PhoneguiGuiWindow;
import palamod.gui.PhoneguiGui;
...
public class PaladiumphoneItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladiumphone")
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PhoneguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Paladiumphone");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PhoneguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
