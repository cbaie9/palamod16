...
public class ChervilItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:chervil")
	public static final Item block = null;

	public ChervilItem(PalamodModElements instance) {
		super(instance, 44);
	}
