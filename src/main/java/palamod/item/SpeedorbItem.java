...
public class SpeedorbItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:speedorb")
	public static final Item block = null;

	public SpeedorbItem(PalamodModElements instance) {
		super(instance, 116);
	}
