...
public class CreativepotgItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:creativepotg")
	public static final Item block = null;

	public CreativepotgItem(PalamodModElements instance) {
		super(instance, 260);
	}
