...
public class HealorbItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:healorb")
	public static final Item block = null;

	public HealorbItem(PalamodModElements instance) {
		super(instance, 115);
	}
