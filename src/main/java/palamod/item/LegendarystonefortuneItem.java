...
public class LegendarystonefortuneItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:legendarystonefortune")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("legendarystonefortune");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			Legendarystonefortune_processProcedure.executeProcedure(
