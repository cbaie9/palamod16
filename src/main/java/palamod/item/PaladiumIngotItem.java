...
public class PaladiumIngotItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladium_ingot")
	public static final Item block = null;

	public PaladiumIngotItem(PalamodModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("paladium_ingot");
		}
