...
public class GreenpaladiumarmorItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:greenpaladiumarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("palamod:greenpaladiumarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("palamod:greenpaladiumarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("palamod:greenpaladiumarmor_boots")
	public static final Item boots = null;

	public GreenpaladiumarmorItem(PalamodModElements instance) {
		super(instance, 60);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(PaladiumGreeningotItem.block));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "greenpaladiumarmor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(PalamodItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "palamod:textures/models/armor/paladium_green__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		...
		}.setRegistryName("greenpaladiumarmor_helmet"));
		...
		}.setRegistryName("greenpaladiumarmor_chestplate"));
		...
		}.setRegistryName("greenpaladiumarmor_leggings"));
		...
		}.setRegistryName("greenpaladiumarmor_boots"));
	}
