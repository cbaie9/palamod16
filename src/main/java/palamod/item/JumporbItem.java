...
public class JumporbItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jumporb")
	public static final Item block = null;

	public JumporbItem(PalamodModElements instance) {
		super(instance, 118);
	}
