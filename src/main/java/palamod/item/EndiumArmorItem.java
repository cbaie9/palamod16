...
public class EndiumArmorItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:endium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("palamod:endium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("palamod:endium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("palamod:endium_armor_boots")
	public static final Item boots = null;

	public EndiumArmorItem(PalamodModElements instance) {
		super(instance, 51);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(PalamodItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "palamod:textures/models/armor/endium__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				FullendiuminvisibleProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
						(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("endium_armor_helmet"));
		...
		}.setRegistryName("endium_armor_chestplate"));
		...
		}.setRegistryName("endium_armor_leggings"));
		...
		}.setRegistryName("endium_armor_boots"));
	}
