...
public class EndiumnuggetItem extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:endiumnugget")
	public static final Item block = null;

	public EndiumnuggetItem(PalamodModElements instance) {
		super(instance, 52);
	}
