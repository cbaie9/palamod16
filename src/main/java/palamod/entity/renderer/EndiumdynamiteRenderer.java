...
@OnlyIn(Dist.CLIENT)
public class EndiumdynamiteRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EndiumdynamiteEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldynamite_t4(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("palamod:textures/endium_dyna_t4.png");
					}
				};
			});
		}
