...
@OnlyIn(Dist.CLIENT)
public class BigdynamiteentityRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BigdynamiteentityEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelBIG_dynamite(), 0.5f) {
