...
public class PalamodModVariables {
	...
	public static String market_name_0 = "not attribued";
	public static String market_name_1 = "not attribued";
	public static String market_name_2 = "not attribued";
	public static String market_name_3 = "not attribued";
	public static String market_name_4 = "not attribued";
	public static String market_name_5 = "not attribued";
	public static String market_name_6 = "not attribued";
	public static String market_name_7 = "not attribued";
	public static String market_name_8 = "not attribued";
	public static String market_name_9 = "not attribued";
	public static double market_price_0 = 0.0;
	public static double market_price_1 = 0.0;
	...
	public static class MapVariables extends WorldSavedData {
		...
		public double market_price_2 = 0.0;
