...
public class XpbushprocessProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (!world.isRemote()) {
			...
			if (_tileEntity != null)
				_tileEntity.getTileData().putDouble("xp_bush_grown_count", (new Object() {
				...
				}.getValue(world, new BlockPos(x, y, z), "xp_bush_grown_count") + 1));
		...
		}.getValue(world, new BlockPos(x, y, z), "xp_bush_grown_count") == 256) {
			{
				BlockPos _bp = new BlockPos(x, y, z);
