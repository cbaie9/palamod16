...
public class PaladiumfurnaceprocesProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == Items.DIAMOND && new Object() {
		...
		}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (0))).getItem() == Items.DIAMOND_SWORD && new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
		...
		if (new Object() {
			...
			if (new Object() {
				...
				if (new Object() {
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == Blocks.COAL_BLOCK.asItem()) {
						{
							TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
							if (_ent != null) {
					...
					}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == Items.BLAZE_POWDER) {
						{
							TileEntity _ent = world.getTileEntity(new BlockPos((int) x, (int) y, (int) z));
							if (_ent != null) {
								final int _sltid = (int) (1);
