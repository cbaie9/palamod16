...
import palamod.procedures.PaladiumcrusherprocessProcedure;
...
public class CrusherguiGui extends PalamodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public CrusherguiGui(PalamodModElements instance) {
		super(instance, 249);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 8, 55) {
				@Override
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 147, 55) {
				@Override
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			PaladiumcrusherprocessProcedure.executeProcedure(Stream
