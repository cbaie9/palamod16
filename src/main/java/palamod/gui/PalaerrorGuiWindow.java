...
@OnlyIn(Dist.CLIENT)
public class PalaerrorGuiWindow extends ContainerScreen<PalaerrorGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = PalaerrorGui.guistate;

	public PalaerrorGuiWindow(PalaerrorGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
