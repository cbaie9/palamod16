...
public class GrinderguiGui extends PalamodModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("grindergui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, GrinderguiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 6, 72) {
				@Override
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 8, 37) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 117, 80) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 56, 72) {
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 66, 26) {
				@Override
