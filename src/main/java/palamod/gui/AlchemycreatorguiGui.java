...
public class AlchemycreatorguiGui extends PalamodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public AlchemycreatorguiGui(PalamodModElements instance) {
		super(instance, 491);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("alchemycreatorgui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AlchemycreatorguiGuiWindow::new));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 123, 5) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (Items.NETHER_WART == stack.getItem());
				}
			}));
