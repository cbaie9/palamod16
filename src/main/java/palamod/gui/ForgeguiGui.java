...
public class ForgeguiGui extends PalamodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public ForgeguiGui(PalamodModElements instance) {
		super(instance, 561);
	...
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, ForgeguiGuiWindow::new));
	}
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			ForgeprocessProcedure.executeProcedure(Stream
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 60, 13) {
			}));
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 61, 53) {
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 105, 31) {
				@Override
