...
@OnlyIn(Dist.CLIENT)
public class Palaerror0001GuiWindow extends ContainerScreen<Palaerror0001Gui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = Palaerror0001Gui.guistate;

	public Palaerror0001GuiWindow(Palaerror0001Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
