...
public class AsemguiGui extends PalamodModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public AsemguiGui(PalamodModElements instance) {
		super(instance, 501);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("asemgui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AsemguiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 126, 37) {
				@Override
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 39, 20) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 57, 20) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 75, 20) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 57, 38) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 75, 38) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 39, 56) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 57, 56) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 75, 56) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
	...
	private static void handleSlotAction(PlayerEntity entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		if (slotID == 0 && changeType == 0) {
			...
			Clear1Procedure.executeProcedure(Stream
		...
		if (slotID == 1 && changeType == 0) {
			...
			AsemprocessProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
