...
public class AdminshopkeyblindingKeyBinding extends PalamodModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.palamod.adminshopkeyblinding", GLFW.GLFW_KEY_O, "key.categories.multiplayer");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			Adminshop_openProcedure.executeProcedure(Stream
