...
public class Erable_StairsBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_stairs")
	public static final Block block = null;

	public Erable_StairsBlock(PalamodModElements instance) {
		super(instance, 96);
	}
