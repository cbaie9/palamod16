...
public class ElevatororangeBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatororange")
	public static final Block block = null;

	public ElevatororangeBlock(PalamodModElements instance) {
		super(instance, 842);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("elevatororange");
		}
