...
public class GrindercasingBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:grindercasing")
	public static final Block block = null;

	public GrindercasingBlock(PalamodModElements instance) {
		super(instance, 132);
	}
