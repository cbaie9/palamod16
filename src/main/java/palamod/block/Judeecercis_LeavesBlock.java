...
public class Judeecercis_LeavesBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_leaves")
	public static final Block block = null;

	public Judeecercis_LeavesBlock(PalamodModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_leaves");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			JudeecerissapdropProcedure.executeProcedure(Stream
