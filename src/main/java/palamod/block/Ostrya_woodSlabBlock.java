...
public class Ostrya_woodSlabBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ostrya_wood_slab")
	public static final Block block = null;

	public Ostrya_woodSlabBlock(PalamodModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ostrya_wood_slab");
		}
