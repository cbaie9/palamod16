...
public class Erable_SlabBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_slab")
	public static final Block block = null;

	public Erable_SlabBlock(PalamodModElements instance) {
		super(instance, 97);
	}
