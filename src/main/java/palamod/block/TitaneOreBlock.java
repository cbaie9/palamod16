...
public class TitaneOreBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:titane_ore")
	public static final Block block = null;

	public TitaneOreBlock(PalamodModElements instance) {
		super(instance, 14);
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.ANDESITE)
				blockCriteria = true;
			if (blockAt.getBlock() == NbtblockBlock.block)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("palamod:titane_ore_match"), () -> CustomRuleTest.codec);
