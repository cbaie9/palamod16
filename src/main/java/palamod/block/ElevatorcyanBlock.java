...
public class ElevatorcyanBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorcyan")
	public static final Block block = null;

	public ElevatorcyanBlock(PalamodModElements instance) {
		super(instance, 239);
	}
