...
public class ElevatorwhiteBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorwhite")
	public static final Block block = null;

	public ElevatorwhiteBlock(PalamodModElements instance) {
		super(instance, 227);
	}
