...
import palamod.procedures.Ametyste_spike_damageProcedure;
...
public class AmetystespikeBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ametystespike")
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			Ametyste_spike_damageProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
