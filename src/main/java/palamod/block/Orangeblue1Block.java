...
public class Orangeblue1Block extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:orangeblue_1")
	public static final Block block = null;

	public Orangeblue1Block(PalamodModElements instance) {
		super(instance, 633);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("orangeblue_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palamod:orangeblue_1"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			Orangeblue1upProcedure.executeProcedure(Stream
