...
public class NbtblockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:nbtblock")
	public static final Block block = null;
	@ObjectHolder("palamod:nbtblock")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public NbtblockBlock(PalamodModElements instance) {
		super(instance, 83);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("nbtblock"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("nbtblock");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Nbt block");
		}
