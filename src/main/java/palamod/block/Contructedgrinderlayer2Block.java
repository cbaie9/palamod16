...
public class Contructedgrinderlayer2Block extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:contructedgrinderlayer_2")
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("contructedgrinderlayer_2");
		}
