...
public class Erable_WoodBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_wood")
	public static final Block block = null;

	public Erable_WoodBlock(PalamodModElements instance) {
		super(instance, 92);
	}
