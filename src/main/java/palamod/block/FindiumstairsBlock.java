...
public class FindiumstairsBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:findiumstairs")
	public static final Block block = null;

	public FindiumstairsBlock(PalamodModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(3)
							.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("findiumstairs");
		}
