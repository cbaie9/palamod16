...
public class Ostrya_woodLeavesBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ostrya_wood_leaves")
	public static final Block block = null;

	public Ostrya_woodLeavesBlock(PalamodModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("ostrya_wood_leaves");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			OstryasapdropProcedure.executeProcedure(Stream
