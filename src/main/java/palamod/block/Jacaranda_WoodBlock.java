...
public class Jacaranda_WoodBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_wood")
	public static final Block block = null;

	public Jacaranda_WoodBlock(PalamodModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jacaranda_wood");
		}
