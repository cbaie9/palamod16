...
public class AngelicwaterBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:angelicwater")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("palamod:angelicwater_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public AngelicwaterBlock(PalamodModElements instance) {
		super(instance, 162);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("palamod:blocks/angelic_water_still"), new ResourceLocation("palamod:blocks/angelic_water_flowing"))
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("angelicwater");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("angelicwater_flowing");
		elements.blocks
				.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER).hardnessAndResistance(100f).setLightLevel(s -> 0)) {
					...
					public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
						...
						Angelicwater_healProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
								(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
					}
				}.setRegistryName("angelicwater"));
		elements.items.add(() -> new BucketItem(still,
				new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(PalamodItemGroup.tab).rarity(Rarity.COMMON))
				.setRegistryName("angelicwater_bucket"));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("angelicwater_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palamod:angelicwater_lakes"), configuredFeature);
		}
	}
