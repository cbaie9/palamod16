...
public class PaladiumOreBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladium_ore")
	public static final Block block = null;

	public PaladiumOreBlock(PalamodModElements instance) {
		super(instance, 3);
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.OAK_PLANKS)
				blockCriteria = true;
			if (blockAt.getBlock() == Blocks.DARK_OAK_PLANKS)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("palamod:paladium_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("paladium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palamod:paladium_ore"), configuredFeature);
		}
	}
