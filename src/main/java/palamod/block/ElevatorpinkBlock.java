...
public class ElevatorpinkBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorpink")
	public static final Block block = null;

	public ElevatorpinkBlock(PalamodModElements instance) {
		super(instance, 838);
	}
