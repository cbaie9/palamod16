...
public class ElevatorlightgrayBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorlightgray")
	public static final Block block = null;

	public ElevatorlightgrayBlock(PalamodModElements instance) {
		super(instance, 238);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("elevatorlightgray");
		}
