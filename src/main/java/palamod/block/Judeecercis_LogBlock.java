...
public class Judeecercis_LogBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_log")
	public static final Block block = null;

	public Judeecercis_LogBlock(PalamodModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_log");
		}
