...
public class PaladiumBlockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladium_block")
	public static final Block block = null;

	public PaladiumBlockBlock(PalamodModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("paladium_block");
		}
