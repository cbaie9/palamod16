...
public class Ostrya_woodPlanksBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ostrya_wood_planks")
	public static final Block block = null;

	public Ostrya_woodPlanksBlock(PalamodModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ostrya_wood_planks");
		}
