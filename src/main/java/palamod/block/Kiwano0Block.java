...
public class Kiwano0Block extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:kiwano_0")
	public static final Block block = null;

	public Kiwano0Block(PalamodModElements instance) {
		super(instance, 210);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("kiwano_0"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palamod:kiwano_0"), configuredFeature);
		}
	}
