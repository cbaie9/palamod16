...
public class CompactedobsidianBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:compactedobsidian")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compactedobsidian");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			CompactedobsidianOnBlockRightClickedProcedure.executeProcedure(Stream
