...
public class Erable_PlanksBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_planks")
	public static final Block block = null;

	public Erable_PlanksBlock(PalamodModElements instance) {
		super(instance, 94);
	}
