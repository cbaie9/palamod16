...
import palamod.gui.AlchemycreatorguiGui;
...
public class Alchimet1Block extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:alchimet_1")
	public static final Block block = null;

	public Alchimet1Block(PalamodModElements instance) {
		super(instance, 130);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Alchemy creator");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new AlchemycreatorguiGui.GuiContainerMod(id, inventory,
