...
public class FindiumBlockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:findium_block")
	public static final Block block = null;

	public FindiumBlockBlock(PalamodModElements instance) {
		super(instance, 66);
	}
