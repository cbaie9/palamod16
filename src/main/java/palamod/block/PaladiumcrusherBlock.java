...
import palamod.gui.CrusherguiGui;
...
public class PaladiumcrusherBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladiumcrusher")
	public static final Block block = null;
	@ObjectHolder("palamod:paladiumcrusher")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PaladiumcrusherBlock(PalamodModElements instance) {
		super(instance, 39);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("paladiumcrusher"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("paladiumcrusher");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Paladium crusher");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("paladiumcrusher");
		}
