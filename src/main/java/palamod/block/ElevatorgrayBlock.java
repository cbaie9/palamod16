...
public class ElevatorgrayBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorgray")
	public static final Block block = null;

	public ElevatorgrayBlock(PalamodModElements instance) {
		super(instance, 237);
	}
