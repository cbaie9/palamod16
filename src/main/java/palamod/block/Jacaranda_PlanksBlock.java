...
public class Jacaranda_PlanksBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_planks")
	public static final Block block = null;

	public Jacaranda_PlanksBlock(PalamodModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jacaranda_planks");
		}
