...
public class Judeecercis_WoodBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_wood")
	public static final Block block = null;

	public Judeecercis_WoodBlock(PalamodModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_wood");
		}
