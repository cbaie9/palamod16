...
import palamod.procedures.TitanespikedamageProcedure;
...
public class TitanespikeBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:titanespike")
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			TitanespikedamageProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
