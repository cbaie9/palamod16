...
public class ElevatorlightgreenBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorlightgreen")
	public static final Block block = null;

	public ElevatorlightgreenBlock(PalamodModElements instance) {
		super(instance, 233);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("elevatorlightgreen");
		}
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			Elevator_processProcedure.executeProcedure(Stream
