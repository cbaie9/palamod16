...
public class TitaneBlockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:titane_block")
	public static final Block block = null;

	public TitaneBlockBlock(PalamodModElements instance) {
		super(instance, 15);
	}
