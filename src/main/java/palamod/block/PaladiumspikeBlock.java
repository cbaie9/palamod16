...
public class PaladiumspikeBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladiumspike")
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			PaladiumspikedamageProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
