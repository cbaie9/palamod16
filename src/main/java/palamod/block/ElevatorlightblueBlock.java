...
public class ElevatorlightblueBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorlightblue")
	public static final Block block = null;

	public ElevatorlightblueBlock(PalamodModElements instance) {
		super(instance, 232);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("elevatorlightblue");
		}
