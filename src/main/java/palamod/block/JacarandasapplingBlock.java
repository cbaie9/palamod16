...
import palamod.procedures.JacarandasapplinggrowProcedure;
...
public class JacarandasapplingBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacarandasappling")
	public static final Block block = null;

	public JacarandasapplingBlock(PalamodModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("jacarandasappling");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			JacarandasapplinggrowProcedure.executeProcedure(Stream
