...
public class Ostrya_woodFenceBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ostrya_wood_fence")
	public static final Block block = null;

	public Ostrya_woodFenceBlock(PalamodModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ostrya_wood_fence");
		}
