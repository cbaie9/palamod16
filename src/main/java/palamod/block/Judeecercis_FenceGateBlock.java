...
public class Judeecercis_FenceGateBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_fence_gate")
	public static final Block block = null;

	public Judeecercis_FenceGateBlock(PalamodModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_fence_gate");
		}
