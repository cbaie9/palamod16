...
public class TrixiumnbtblockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:trixiumnbtblock")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("trixiumnbtblock");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("contain trixum scoreboard ( do not break )"));
		}
