...
public class TrxiumblockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:trxiumblock")
	public static final Block block = null;

	public TrxiumblockBlock(PalamodModElements instance) {
		super(instance, 207);
	}
