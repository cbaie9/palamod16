...
public class Jacaranda_LeavesBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_leaves")
	public static final Block block = null;

	public Jacaranda_LeavesBlock(PalamodModElements instance) {
		super(instance, 78);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("jacaranda_leaves");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			JacarandasapdropProcedure.executeProcedure(Stream
