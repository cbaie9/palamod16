...
public class TitaneslabBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:titaneslab")
	public static final Block block = null;

	public TitaneslabBlock(PalamodModElements instance) {
		super(instance, 17);
	}
