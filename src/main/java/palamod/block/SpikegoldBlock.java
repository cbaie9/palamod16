...
public class SpikegoldBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:spikegold")
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			GoldspikedamageProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
