...
public class PaladiumGreenblockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladium_greenblock")
	public static final Block block = null;

	public PaladiumGreenblockBlock(PalamodModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("paladium_greenblock");
		}
