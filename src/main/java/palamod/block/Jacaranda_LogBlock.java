...
public class Jacaranda_LogBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_log")
	public static final Block block = null;

	public Jacaranda_LogBlock(PalamodModElements instance) {
		super(instance, 76);
	}
