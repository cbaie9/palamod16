...
public class ElevatorredBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorred")
	public static final Block block = null;

	public ElevatorredBlock(PalamodModElements instance) {
		super(instance, 835);
	}
