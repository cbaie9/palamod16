...
public class Judeecercis_PlanksBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_planks")
	public static final Block block = null;

	public Judeecercis_PlanksBlock(PalamodModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_planks");
		}
