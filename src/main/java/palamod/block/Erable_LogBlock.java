...
public class Erable_LogBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_log")
	public static final Block block = null;

	public Erable_LogBlock(PalamodModElements instance) {
		super(instance, 93);
	}
