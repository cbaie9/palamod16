...
public class AmethysteBlockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:amethyste_block")
	public static final Block block = null;

	public AmethysteBlockBlock(PalamodModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amethyste_block");
		}
