...
public class Ostrya_woodLogBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ostrya_wood_log")
	public static final Block block = null;

	public Ostrya_woodLogBlock(PalamodModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ostrya_wood_log");
		}
