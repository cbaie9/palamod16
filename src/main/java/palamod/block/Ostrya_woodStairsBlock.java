...
public class Ostrya_woodStairsBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ostrya_wood_stairs")
	public static final Block block = null;

	public Ostrya_woodStairsBlock(PalamodModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ostrya_wood_stairs");
		}
