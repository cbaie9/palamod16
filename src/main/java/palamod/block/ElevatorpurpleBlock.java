...
public class ElevatorpurpleBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorpurple")
	public static final Block block = null;

	public ElevatorpurpleBlock(PalamodModElements instance) {
		super(instance, 236);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("elevatorpurple");
		}
