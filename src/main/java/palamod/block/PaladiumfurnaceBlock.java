...
public class PaladiumfurnaceBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladiumfurnace")
	public static final Block block = null;
	@ObjectHolder("palamod:paladiumfurnace")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public PaladiumfurnaceBlock(PalamodModElements instance) {
		super(instance, 135);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("paladiumfurnace"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("paladiumfurnace");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("paladiumfurnace");
		}
