...
public class Jacaranda_StairsBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_stairs")
	public static final Block block = null;

	public Jacaranda_StairsBlock(PalamodModElements instance) {
		super(instance, 79);
	}
