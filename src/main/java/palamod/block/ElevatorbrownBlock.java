...
public class ElevatorbrownBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorbrown")
	public static final Block block = null;

	public ElevatorbrownBlock(PalamodModElements instance) {
		super(instance, 234);
	}
