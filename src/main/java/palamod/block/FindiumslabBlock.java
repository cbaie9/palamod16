...
public class FindiumslabBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:findiumslab")
	public static final Block block = null;

	public FindiumslabBlock(PalamodModElements instance) {
		super(instance, 109);
	}
