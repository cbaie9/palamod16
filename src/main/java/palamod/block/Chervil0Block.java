...
import palamod.procedures.Chervil0upProcedure;
...
public class Chervil0Block extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:chervil_0")
	public static final Block block = null;

	public Chervil0Block(PalamodModElements instance) {
		super(instance, 203);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("chervil_0"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palamod:chervil_0"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			Chervil0upProcedure.executeProcedure(Stream
