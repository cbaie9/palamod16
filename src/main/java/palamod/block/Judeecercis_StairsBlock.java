...
public class Judeecercis_StairsBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_stairs")
	public static final Block block = null;

	public Judeecercis_StairsBlock(PalamodModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_stairs");
		}
