...
public class ColofullampBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:colofullamp")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.LANTERN).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
			setRegistryName("colofullamp");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ColoredlampBlock.block));
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				ColofullampRedstoneOffProcedure.executeProcedure(Stream
