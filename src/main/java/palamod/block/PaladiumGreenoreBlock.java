...
public class PaladiumGreenoreBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:paladium_greenore")
	public static final Block block = null;

	public PaladiumGreenoreBlock(PalamodModElements instance) {
		super(instance, 53);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("paladium_greenore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("palamod:paladium_greenore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("paladium_greenore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palamod:paladium_greenore"), configuredFeature);
		}
	}
