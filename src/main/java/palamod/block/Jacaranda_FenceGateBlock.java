...
public class Jacaranda_FenceGateBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_fence_gate")
	public static final Block block = null;

	public Jacaranda_FenceGateBlock(PalamodModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("jacaranda_fence_gate");
		}
