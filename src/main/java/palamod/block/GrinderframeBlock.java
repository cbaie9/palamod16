...
public class GrinderframeBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:grinderframe")
	public static final Block block = null;

	public GrinderframeBlock(PalamodModElements instance) {
		super(instance, 133);
	}
