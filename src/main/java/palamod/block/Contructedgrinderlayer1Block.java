...
public class Contructedgrinderlayer1Block extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:contructedgrinderlayer_1")
	public static final Block block = null;

	public Contructedgrinderlayer1Block(PalamodModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("contructedgrinderlayer_1");
		}
