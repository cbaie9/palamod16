...
public class Jacaranda_SlabBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_slab")
	public static final Block block = null;

	public Jacaranda_SlabBlock(PalamodModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("jacaranda_slab");
		}
