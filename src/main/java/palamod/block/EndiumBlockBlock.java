...
public class EndiumBlockBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:endium_block")
	public static final Block block = null;

	public EndiumBlockBlock(PalamodModElements instance) {
		super(instance, 46);
	}
