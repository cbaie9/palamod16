...
public class ElevatorblueBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:elevatorblue")
	public static final Block block = null;

	public ElevatorblueBlock(PalamodModElements instance) {
		super(instance, 229);
	}
