...
public class Jacaranda_FenceBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:jacaranda_fence")
	public static final Block block = null;

	public Jacaranda_FenceBlock(PalamodModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("jacaranda_fence");
		}
