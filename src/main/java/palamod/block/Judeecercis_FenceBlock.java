...
public class Judeecercis_FenceBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_fence")
	public static final Block block = null;

	public Judeecercis_FenceBlock(PalamodModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_fence");
		}
