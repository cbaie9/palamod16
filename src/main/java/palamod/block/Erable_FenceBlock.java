...
public class Erable_FenceBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_fence")
	public static final Block block = null;

	public Erable_FenceBlock(PalamodModElements instance) {
		super(instance, 98);
	}
