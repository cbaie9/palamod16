...
public class Judeecercis_SlabBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:judeecercis_slab")
	public static final Block block = null;

	public Judeecercis_SlabBlock(PalamodModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("judeecercis_slab");
		}
