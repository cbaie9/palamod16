...
public class Erable_FenceGateBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_fence_gate")
	public static final Block block = null;

	public Erable_FenceGateBlock(PalamodModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("erable_fence_gate");
		}
