...
public class Erable_LeavesBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:erable_leaves")
	public static final Block block = null;

	public Erable_LeavesBlock(PalamodModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			ErablesapdropProcedure.executeProcedure(Stream
