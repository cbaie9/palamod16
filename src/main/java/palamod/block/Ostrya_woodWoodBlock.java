...
public class Ostrya_woodWoodBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:ostrya_wood_wood")
	public static final Block block = null;

	public Ostrya_woodWoodBlock(PalamodModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ostrya_wood_wood");
		}
