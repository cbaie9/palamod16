...
public class Orangeblue2Block extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:orangeblue_2")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("orangeblue_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("palamod:orangeblue_2"), configuredFeature);
		}
	}
