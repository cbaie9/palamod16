...
public class FalsetresureBlock extends PalamodModElements.ModElement {
	@ObjectHolder("palamod:falsetresure")
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			FalsetresureOnBlockRightClickedProcedure.executeProcedure(Stream
